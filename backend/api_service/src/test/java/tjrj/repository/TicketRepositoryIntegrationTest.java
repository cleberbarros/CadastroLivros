...
public class TicketRepositoryIntegrationTest {
    ...
    void whenFindByUserId_thenPageOfTicketsIsReturned() {
        // Act
        Page<Livro> result = ticketRepository.findByUserId(ticket.getUserId(), PageRequest.of(0, 10));
    ...
    void whenFindByUserIdAndTicketId_thenCorrectTicketIsReturned() {
        // Act
        Optional<Livro> found = ticketRepository.findByUserIdAndTicketId(ticket.getUserId(), ticket.getId());
    ...
    void whenFindByUserIdAndDescriptionContaining_thenPageOfTicketsIsReturned() {
        // Act
        Page<Livro> result = ticketRepository.findByUserIdAndDescriptionContaining(ticket.getUserId(), "sample",
                PageRequest.of(0, 10));
